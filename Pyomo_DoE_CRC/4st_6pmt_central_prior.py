...
PRIOR_LAMBDA = 1e-6
UNKNOWN_PARAMETER_ATTRS = ["a1", "a2", "a3", "a4", "a5", "a6"]
...
class SixParameterExperiment(Experiment):
    ...
    def label_experiment(self):
        ...
        unknown_parameter_vars = [getattr(m, name) for name in UNKNOWN_PARAMETER_ATTRS]
        m.unknown_parameters.update((k, pyo.value(k)) for k in unknown_parameter_vars)
...
p = len(UNKNOWN_PARAMETER_ATTRS)
prior_FIM = PRIOR_LAMBDA * np.eye(p)
